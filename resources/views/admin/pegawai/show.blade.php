                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <input disabled type="text" value="{{ old('name', $pegawai->name) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input disabled type="email" value="{{ old('email', $pegawai->email) }}" name="email"
                            ...
                            <select disabled name="id_jabatan" class="form-control">
                            ...
                            <div class="row mb-3">
                                ...
                                <input disabled type="text" value="{{ old('nip', $pegawai->nip) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <input disabled type="text" value="{{ old('telepon', $pegawai->telepon) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <select disabled id="agama" name="agama" required
                            ...
                            <div class="row mb-3">
                                ...
                                <input disabled type="text" value="{{ old('alamat', $pegawai->alamat) }}" class="form-control
                            ...
                            <div class="row mb-3">
                                <label for="status_pegawai" class="block text-sm font-medium text-gray-700">Status
                                    Pegawai</label>
                                <select disabled name="status_pegawai" class="form-control">
