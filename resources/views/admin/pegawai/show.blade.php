                                                ...
                                                <ol class="profile-section list-unstyled mb-md-0 px-4">
                                                    <li class="profile-item">
                                                        <div class="avatar-sm profile-icon p-1">
                                                            <div class="avatar-title rounded-2 bg-light"
                                                                ...
                                                                <span class="mdi mdi-badge-account-outline bg-dark"></span>
                                                            </div>
                                                        </div>
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Nama</h5>
                                                            <p class="font-size-15">{{ $pegawai->name }}</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            ...
                                                            <p class="font-size-15">{{ $pegawai->email }}</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">No Induk Pekerja</h5>
                                                            <p class="font-size-15">{{ $pegawai->nip }}</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Telepon</h5>
                                                            <p class="font-size-15">{{ $pegawai->telepon }}</p>
                                                        </div>
                                                    </li>
                                                </ol>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Tempat Lahir</h5>
                                                            <p class="font-size-15">{{ $pegawai->tempat_lahir }}</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Tanggal Lahir</h5>
                                                            <p class="font-size-15">{{ $pegawai->tgl_lahir }}</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Agama</h5>
                                                            <p class="font-size-15">{{ $pegawai->agama }}</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Alamat</h5>
                                                            <p class="font-size-15">{{ $pegawai->alamat }}</p>
                                                        </div>
                                                    </li>
                                                </ol>
                                            </div>
